...
shapiro.test(AandO_H2_all[i >= 100 & i <= 300][instar == "instar 2"][group == "O"][label == 'T']$h2)
shapiro.test(AandO_H2_all[i >= 100 & i <= 300][instar == "instar 1"][group == "A"][label == 'C']$h2)
shapiro.test(AandO_H2_all[i >= 100 & i <= 300][instar == "instar 2"][group == "A"][label == 'T']$h2)


# O_I1_plast
wilcox_O_I1_plast <- wilcox.test(h2 ~ treatment, data =O_h2_all[i >= 100 & i <= 300][instar == "instar 1"]) 

Zscore_O_I1_plast = qnorm(wilcox_O_I1_plast$p.value/2)
Zscore_O_I1_plast

wilcox_effectsize_O_I1_plast <- wilcox_effsize(h2 ~ treatment, data =O_h2_all[i >= 100 & i <= 300][instar == "instar 1"])
wilcox_effectsize_O_I1_plast

# (Z = -4.651, r =  0.232, p-value = 3.311e-06)


# O_I2_plast
wilcox_O_I2_plast <- wilcox.test(h2 ~ treatment, data =O_h2_all[i >= 100 & i <= 300][instar == "instar 2"]) 

Zscore_O_I2_plast = qnorm(wilcox_O_I2_plast$p.value/2)
Zscore_O_I2_plast

wilcox_effectsize_O_I2_plast <- wilcox_effsize(h2 ~ treatment, data =O_h2_all[i >= 100 & i <= 300][instar == "instar 2"])
wilcox_effectsize_O_I2_plast

# (Z = -11.700, r =  0.584, p-value < 2.2e-16)
